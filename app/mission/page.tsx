    ...
    <div className="max-w-4xl mx-auto pt-20 text-white">
      ...
      <div className="bg-gray-800 p-8 rounded-lg shadow-lg mb-12 border border-gray-700">
        ...
        <p className="text-lg text-gray-300 mb-6">
          Reel It Back seeks to capture the harmony between influencers and brands, connecting the expressive energy of influencers with the intentional vision of brands.
        </p>
      ...
      <div className="prose lg:prose-xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-purple-900 to-indigo-900 p-6 rounded-lg shadow-inner my-8">
          <blockquote className="italic text-gray-300 border-l-4 border-purple-500 pl-4">
            &quot;Our platform thrives on the belief that partnerships must be meaningful and authentic. Reel It Back is not merely about bridging gaps; it is about weaving relationships where identity and vibe amplify each other, creating collaborations that stand out and leave a lasting impact.&quot;
          </blockquote>
        </div>
